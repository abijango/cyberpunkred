...
//! [`NetrunState`] is now the real type from WP-402 (`crate::netrunning::state`).
//! [`GigState`] remains a placeholder until WP-604 lands.
//! Defining the slots now lets every downstream WP refer to a stable
//! [`World`] shape.
